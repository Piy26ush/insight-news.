...
const CATEGORY_KEYWORDS: Record<ArticleCategory, string[]> = {
  AI: [
    ...
    "generative ai", "chatbot", "transformer", "diffusion model", "copilot",
    "ai agent", "agentic", "agi", "alignment", "fine-tuning", "prompt",
    "stable diffusion", "midjourney", "hugging face", "langchain", "vector database",
    "rag", "retrieval augmented", "ai safety", "superintelligence",
  ],
  Science: [
    "nasa", "isro", "spacex", "space", "astronomy", "telescope", "exoplanet",
    "jwst", "mars", "moon", "rocket", "satellite", "orbit",
    "crispr", "gene therapy", "dna", "rna", "clinical trial", "vaccine",
    "quantum", "qubit", "fusion", "particle physics", "cern",
    "climate change", "carbon capture", "renewable energy", "biodiversity",
    "neuroscience", "stem cell", "biology", "chemistry", "physics",
  ],
  Markets: [
    "stock", "market", "nasdaq", "s&p 500", "dow jones", "nifty", "sensex",
    "fed", "federal reserve", "interest rate", "inflation", "gdp",
    "ipo", "earnings", "revenue", "profit", "dividend", "valuation",
    "crude oil", "gold price", "bitcoin", "crypto", "forex",
    "bull", "bear", "rally", "selloff", "correction",
    "rbi", "monetary policy", "fiscal", "bond", "yield", "treasury",
    "mutual fund", "etf", "hedge fund", "venture capital",
  ],
  Tech: [
    "apple", "google", "microsoft", "amazon", "meta", "nvidia", "tesla",
    "semiconductor", "chip", "processor", "gpu",
    "software", "hardware", "startup", "saas", "cloud computing",
    "cybersecurity", "hack", "breach", "zero-day", "malware", "ransomware",
    "blockchain", "web3", "metaverse", "vr", "ar", "mixed reality",
    "5g", "6g", "internet", "browser", "app", "developer",
    "electric vehicle", "ev", "autonomous driving", "self-driving",
    "figma", "github", "docker", "kubernetes", "devops",
  ],
  Global: [
    "geopolitics", "diplomacy", "sanctions", "trade war", "nato",
    "un", "united nations", "g20", "g7", "summit", "treaty",
    "election", "parliament", "congress", "legislation", "policy",
    "war", "conflict", "ceasefire", "refugee", "humanitarian",
    "india", "china", "russia", "ukraine", "usa", "eu", "europe",
